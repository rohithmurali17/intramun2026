      ...
      <div className="relative mx-auto max-w-[1400px] px-6">
        ...
        <div className="mt-14 grid md:grid-cols-2 gap-px bg-border border border-border">
          ...
          <div className="group bg-[oklch(0.22_0.045_190)] p-8 md:p-12 relative">
            <span className="absolute top-6 right-6 font-mono text-[10px] tracking-[0.25em] uppercase text-primary border border-primary/60 px-2 py-1 text-right">MIN · 8<br />MAX . 15</span>
            ...
            <p className="mt-4 text-foreground/70 leading-relaxed">Bring your crew. 8 members minimum, 15 members maximum, while ensuring the delegation covers all 4 committees. Compete together. Win together. The ₹8,000 cash prize is built for you.</p>
