...
export function BgmPlayer() {
  ...
  return (
    <button
      ...
      disabled={!ready}
      className="fixed top-4 right-[10.5rem] z-[100] flex h-9 w-9 items-center justify-center rounded-full border border-[color:var(--mun-gold)]/40 bg-background/70 backdrop-blur-md transition-all hover:border-[color:var(--mun-gold)] hover:shadow-[var(--shadow-gold)]"
    >
